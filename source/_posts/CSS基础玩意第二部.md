...
十四、flex布局
flex布局是伸缩布局（可将子元素自动转为行内块元素），非常方便的布局手段（多用于移动端），要点：
&#8195;1、用法：display:flex;
&#8195;2、主要属性：
&#8195;&#8195;（1）flex-direction:主轴方向，即元素排版的方向；
&#8195;&#8195;&#8195;&#8195;参数值：
&#8195;&#8195;&#8195;&#8195;1）row：沿x轴排列；
&#8195;&#8195;&#8195;&#8195;2）column：沿y轴排列；
&#8195;&#8195;（2）justify-content：主轴方向上元素的对齐方式；
&#8195;&#8195;&#8195;&#8195;参数值：
&#8195;&#8195;&#8195;&#8195;1）flex-start：主轴方向上首对齐；
&#8195;&#8195;&#8195;&#8195;2）flex-end：主轴方向上底对齐；
&#8195;&#8195;&#8195;&#8195;3）center：主轴方向上居中对齐；
&#8195;&#8195;&#8195;&#8195;4）space-between：元素之间有间隙且间隙平均分布；
&#8195;&#8195;&#8195;&#8195;5）space-around：元素的前后左右都有间隙，相当于是添加了外边距；
&#8195;&#8195;（3）align-items：交叉轴方向上的对齐方式，即垂直对齐；
&#8195;&#8195;&#8195;&#8195;参数值：
&#8195;&#8195;&#8195;&#8195;1）flex-start：垂直对齐开始位置，首对齐；
&#8195;&#8195;&#8195;&#8195;2）flex-center：垂直对齐结束位置，底对齐；
...
二十七、旋转
使得元素沿着x、y或z轴旋转指定的角度，使用transform属性来设置，可选属性值：
&8195;（1）rotateX()：沿着x轴旋转，可填旋转角度(deg)和旋转圈数(turn)，例如45deg(45°)、.5turn(0.5圈)；
&8195;（2）rotateY()：沿着y轴旋转，可填旋转角度(deg)和旋转圈数(turn)，例如45deg(45°)、.5turn(0.5圈)；
&8195;（3）rotateZ()：沿着z轴旋转，可填旋转角度(deg)和旋转圈数(turn)，例如45deg(45°)、.5turn(0.5圈)；
另外，在元素旋转的过程中，可以使用backface-visibility属性来设置是否显示元素的背面，可选值：
&8195;（1）visible：默认值，显示元素背面；
&8195;（2）hidden：隐藏元素背面；
&8195;（2）hidden：隐藏元素背面；

二十八、缩放
使得元素沿x、y或z轴放大或缩小，可选属性值：
&8195;（1）scaleX()：沿着水平方向缩放，括号内填写缩放的倍数，例如：scaleX(.2)，表示缩放到原来的0.2倍；
&8195;（2）scaleY()：沿着垂直方向缩放，括号内填写缩放的倍数，例如：scaleY(.2)，表示缩放到原来的0.2倍；
&8195;（3）scaleZ()：沿着z轴方向缩放，括号内填写缩放的倍数，例如：scaleZ(.2)，表示缩放到原来的0.2倍，z轴方向的缩放需要有更进一步的设置才能看到效果
